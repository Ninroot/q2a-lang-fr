...
#     	ajouts pour la 1.7 par Pierre-Yves Aillet (pierreyves.aillet@free.fr)
	...
	return array(
		...
		'captcha_module' => 'Utiliser le modile de captcha:',
		...
		'confirm_user_emails' => 'Demande confirmation des e-mails de l\'utilisateur:',
		...
		'do_close_on_select' => 'Fermer les questions avec une réponse séléctionnée:',
		'do_complete_tags' => 'Afficher les mots clés correspondant en tapant:',
		'do_count_q_views' => 'Compter le nombre question vue:',
		'do_example_tags' => 'Afficher un exemple mots clés basés sur question:',
		'editor_for_as' => 'Editeur par défaut pour les réponses:',
		'editor_for_cs' => 'Editeur par défaut pour les commentaires:',
		'editor_for_qs' => 'Editeur par défaut pour les questions:',
		'email_privacy' => 'Note de confidentialité pour les adresses e-mail - HTML autorisés:',
		...
		'feedback_email' => 'Adresse e-mail pour les messages admin - ne pas montré aux utilisateurs:',
		...
		'flagging_of_posts' => 'Autoriser les messages à être signalé:',
		'follow_on_as' => 'Autoriser les questions soient liés à des réponses:',
		'from_email' => 'Adresse de l\'expéditeur des messages à partir du site:',
		'hot_weight_a_age' => 'Question a une nouvelle réponse:',
		'hot_weight_answers' => 'Question a beaucoup de réponses:',
		'hot_weight_q_age' => 'Question est nouvelle:',
		'hot_weight_views' => 'Question a de nombreuses visites:',
		'hot_weight_votes' => 'Question has a beaucoup de votes pour:',
		...
		'max_rate_ip_as' => 'Limite ajout de réponses:',
		'max_rate_ip_cs' => 'Limite ajout de commentaires:',
		'max_rate_ip_flags' => 'Limite de signalement de messages:',
		'max_rate_ip_logins' => 'Limite de connection:',
		'max_rate_ip_messages' => 'Limite messages sur le mur et messages privés:',
		'max_rate_ip_qs' => 'Limite poser une question:',
		'max_rate_ip_registers' => 'Limite inscription dùtilisateur:',
		'max_rate_ip_uploads' => 'Limite envoi de fichiers:',
		'max_rate_ip_votes' => 'Limite vote:',
		...
		'max_rate_user_flags' => 'Maximum signalements par utilisateur par heure:',
		'max_rate_user_messages' => 'Maximum messages privés par utilisateur par heure:',
		'max_rate_user_qs' => 'Maximum de questions par utilisateur par heure:',
		'max_rate_user_uploads' => 'Maximum envois de fichiers par utilisateur par heure:',
		...
		'moderate_edited_again' => 'Messages Re-modérée après l\'édition:',
		...
		'notify_admin_q_post' => 'Email cette adresse quand une question est posté',
		...
		'page_size_related_qs' => 'Nombre maximum de question liées:',
		'page_size_search' => 'Nombre de résultat de recherche par page:',
		'page_size_tag_qs' => 'Nombre de question sur une page de mot clé:',
		...
		'show_custom_ask' => 'Message personnalisé sur formulaire de question - HTML autorisés:',
		...
		'site_theme_mobile' => 'Théme pour mobiles:',
		'site_theme' => 'Théme du site:',
